...
class IndexController extends Controller
{
    ...
    public function chapter($id, $slug) {
        ...
        $danhmuc = DanhmucTruyen::orderBy('id','DESC')->get();  
        return view('pages.chapter')->with(compact('danhmuc','chapter','allchapter','nextID','nextSlug','backID','backSlug','maxID','minID')); 
    }
    ...
    {
        $truyen = Truyen::where('tentruyen','LIKE','%'.$request->e.'%')->get();
        return $truyen;
    }
