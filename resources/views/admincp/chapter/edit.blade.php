    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('chapter.update', [$chapter->id]) }}">
            ...
            <div class="form-group">
                ...
                <input type="" class="form-control" name="tieude" value="{{$chapter->tieude}}" id="slug" onkeyup="ChangeToSlug();"
                    placeholder="Tên chapter">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Slug chapter</label>
                <input type="" class="form-control" name="slug_chapter" value="{{$chapter->slug_chapter}}" id="convert_slug" placeholder="Slug chapter">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="noidung" id="noidung" class="form-control">{{$chapter->noidung}}</textarea>
            </div>
            <div class="form-group">
